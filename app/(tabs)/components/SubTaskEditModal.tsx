...
interface SubTaskEditModalProps {
  ...
  onSave: (task: SubTaskLocalState) => void;
  onDelete: (id: string | number) => void;
  themeColor: string;
}

interface SubTaskLocalState extends Omit<SubTask, "date" | "endTime"> {
  date: Date;
  endTime: Date;
}
...
export default function SubTaskEditModal({
  ...
  const [taskData, setTaskData] = useState<SubTaskLocalState | null>(null);
            ...
            <View style={[styles.content, { borderTopColor: themeColor }]}>
                ...
                <View style={styles.expandedArea}>
                  ...
                  >
                    ...
                    <ModernDatePicker
                      ...
                      mode="time"
                      onChange={(d: Date) =>
                        setTaskData({ ...taskData, endTime: d })
                      }
                      themeColor={themeColor}
                      icon="time-outline"
                    />
                  ...
                  >
                    {[
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.chip,
                          taskData.reminderOption === opt.v && {
                            backgroundColor: themeColor,
                            borderColor: themeColor,
                          },
                        ]}
                        onPress={() =>
                          setTaskData({ ...taskData, reminderOption: opt.v })
                        }
                      >
                        <Text
                          style={[
              ...
              <View style={styles.settingRow}>
                ...
                <Switch
                  ...
                  onValueChange={(v) =>
                    setTaskData({ ...taskData, isExpense: v })
                  }
                  trackColor={{ false: "#C7C7CC", true: themeColor }}
                />
              </View>
              ...
              {taskData.isExpense && (
                <View style={styles.amountInputContainer}>
                  <Text style={[styles.yenSymbol, { color: themeColor }]}>
                    ¥
                  </Text>
                  <TextInput
                    ...
                    onChangeText={(t) =>
                      setTaskData({ ...taskData, amount: parseInt(t) || 0 })
                    }
