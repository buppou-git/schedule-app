      ...
      <View style={styles.container}>
            ...
            <View style={styles.featureBox}>
              ...
              <View style={styles.featureText}>
                ...
                <Text style={styles.featureDesc}>
                  日々のスケジュールも、毎日の習慣も、出費も、アプリを分けずに同じカレンダーの上で直感的に管理できます。
                </Text>
              </View>
            </View>
          ...
          <View style={styles.slide}>
            ...
            >
              <View style={[styles.featureBox, { marginBottom: 15 }]}>
                ...
                <View style={styles.featureText}>
                  ...
                  <Text style={styles.featureDesc}>
                    情報科学の講義やゼミ、アルバイトなど、時間が決まっているスケジュールを管理します。
                  </Text>
                </View>
              </View>
              ...
              <View style={[styles.featureBox, { marginBottom: 15 }]}>
                ...
                <View style={styles.featureText}>
                  ...
                  <Text style={styles.featureDesc}>
                    TOEIC900点に向けた学習タスクや、「スクワット100回・腕立て60回」のような毎日の筋トレルーティンも進捗管理できます。
                  </Text>
                </View>
              </View>
              ...
              <View style={[styles.featureBox, { marginBottom: 15 }]}>
                ...
                <View style={styles.featureText}>
                  ...
                  <Text style={styles.featureDesc}>
                    参考書の購入代や交際費など、日々の出費をカレンダーに直接記録し、予算を把握できます。
                  </Text>
                </View>
              </View>
            </ScrollView>
            ...
            >
              <TouchableOpacity
                style={[
                  styles.nextBtn,
                  { flex: 1, backgroundColor: "#E5E5EA" },
                ]}
                onPress={() => setStep(1)}
              >
                <Text style={[styles.nextBtnText, { color: "#1C1C1E" }]}>
                  戻る
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.nextBtn, { flex: 2 }]}
                onPress={handleNext}
              >
                <Text style={styles.nextBtnText}>次へ</Text>
              </TouchableOpacity>
          ...
          <View style={styles.slide}>
            ...
            <View style={styles.featureBox}>
              ...
              <View style={styles.featureText}>
                ...
                <Text style={styles.featureDesc}>
                  「ゼミ合宿」や「家族の予定」などをレイヤーとして追加し、URL一つでシームレスに同期できます。
                </Text>
              </View>
            </View>
        ...
        {step === 4 && (
          <View style={styles.slide}>
            ...
            <Text style={styles.subTitle}>
              UniCalをどのような用途で使いますか？
            </Text>
            <Text style={styles.hintText}>
              複数選択可能です。選んだ用途に合わせて、カテゴリ（レイヤー）と表示プリセットを自動でセットアップします。
            </Text>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <Ionicons
                        name={
                          template.icon as React.ComponentProps<
                            typeof Ionicons
                          >["name"]
                        }
                        size={24}
