...
export default function TabBar({ activeMode, setActiveMode, themeColor }: TabBarProps) {
    ...
    return (
        <View style={[styles.tabContainer, { backgroundColor: "transparent" }]}>
            {/* 📅 カレンダー タブ */}
            <TouchableOpacity
                style={[styles.tabButton, activeMode === "calendar" && { backgroundColor: themeColor + "1A" }]}
            ...
            >
                ...
                />
               <Text style={[styles.tabText, activeMode === "calendar" && { color: themeColor, fontWeight: "bold" }]}>
                    予定
                </Text>
            </TouchableOpacity>
         ...
         {/* ✅ ToDo タブ */}
      <TouchableOpacity
        style={[styles.tabButton, activeMode === "todo" && { backgroundColor: themeColor + "1A" }]}
      ...
      >
        ...
        />
        <Text style={[styles.tabText, activeMode === "todo" && { color: themeColor, fontWeight: "bold" }]}>
          タスク
        </Text>
      </TouchableOpacity>
      ...
      {/* 💰 家計簿 タブ */}
      <TouchableOpacity
        style={[styles.tabButton, activeMode === "money" && { backgroundColor: themeColor + "1A" }]}
      ...
      >
        ...
        />
        <Text style={[styles.tabText, activeMode === "money" && { color: themeColor, fontWeight: "bold" }]}>
          家計簿
        </Text>
      </TouchableOpacity>
    </View>
